...
/**
 * eCheck checkout block integration.
 *
 * @since 2.14.0
 *
 * @property \WC_Elavon_Converge $plugin the plugin instance
 * @property \WC_Gateway_Elavon_Converge_eCheck $gateway the gateway instance
 */
class Electronic_Check_Checkout_Block_Integration extends Gateway_Checkout_Block_Integration {
	 ...
	 * @param \WC_Gateway_Elavon_Converge_eCheck $gateway
	...
	public function add_payment_method_data( array $payment_method_data, SV_WC_Payment_Gateway $gateway ) : array {
		...
		$payment_method_data['gateway'] = array_merge(
			...
			[ 'authorization_terms' => $gateway->get_authorization_terms() ],
